    ...
    <div className="w-full relative py-20 sm:py-24 md:py-32 px-4 sm:px-6 md:px-10 lg:px-16 overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <h2 className="font-raleway font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white leading-tight mb-4 sm:mb-6">
          Your Next <span className="text-[#FF5733]">Finish Line</span> Awaits
        </h2>
        <p className="font-merriweather-sans text-base sm:text-lg text-white/70 mb-8 sm:mb-10 max-w-lg mx-auto leading-relaxed">
          Sign up today and join a global community of runners. Your first race
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <Link
            href="/race"
            className="font-raleway font-bold text-sm sm:text-base text-white/70 hover:text-[#FFB800] transition-colors underline underline-offset-4 decoration-white/25 hover:decoration-[#FFB800]"
          >
            Explore Races →
          </Link>
        </div>
