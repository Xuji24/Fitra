      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 py-20 sm:py-24">
        <div className="max-w-2xl">
          ...
          <p className="font-merriweather-sans text-base sm:text-lg md:text-xl text-white/80 mb-8 sm:mb-10 leading-relaxed max-w-lg">
            Join thousands of runners worldwide. Track progress, compete in
            virtual races, and transform your fitness journey.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start">
            ...
            <Link href="/race">
              <Button
                variant="outline"
                className="font-raleway font-bold text-base sm:text-lg bg-white/10 backdrop-blur-sm text-white border-white/25 hover:bg-white/20 hover:border-white/40 transition-all px-8 sm:px-10 py-3 sm:py-4 rounded-full cursor-pointer"
              >
                Browse Races
              </Button>
            </Link>
